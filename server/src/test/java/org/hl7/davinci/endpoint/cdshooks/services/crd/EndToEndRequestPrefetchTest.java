...
public class EndToEndRequestPrefetchTest {
  ...
  private String deviceRequestEmptyPrefetchJson = FileUtils
      .readFileToString(new ClassPathResource("deviceRequestEmptyPrefetch.json").getFile(),
          Charset.defaultCharset());
  private String deviceRequestPrefetchResponseJson = FileUtils
      .readFileToString(new ClassPathResource("deviceRequestPrefetchResponse.json").getFile(),
          Charset.defaultCharset());
  private String prefetchUrl = "/DeviceRequest?id=24439"
  ...
  public void shouldSuccessfullyFillPreFetch() {
    ...
    JsonNode cards = restTemplate
        .postForObject("http://localhost:" + port + "/cds-services/order-review-crd", entity,
            JsonNode.class);
