...
export default class KeyInterface extends Component{
    ...
    async componentDidMount(){
        if(this.props.doFetch){
            var jwtData = await fetch(config.baseUrl+'/api/public', {
                method: 'GET',
                headers: {
    ...
    async saveData(keyObject){
        ...
        if(this.props.doFetch){
            await fetch(config.baseUrl+'/api/public', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
    ...
    async deleteData(id){
        if(this.props.doFetch){
            await fetch(config.baseUrl +'/api/public/'+id, {
                method: 'DELETE',
                headers: {
                    'Accept': 'application/json',
                    'Content': 'application/json'
    ...
    async editData(oldId,keyObject){
        ...
        if(this.props.doFetch){
            await fetch(config.baseUrl +'/api/public/'+oldId, {
                method: 'PUT',
                headers: {
                    'Accept': 'application/json',
