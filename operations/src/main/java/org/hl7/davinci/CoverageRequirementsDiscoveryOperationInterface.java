...
0..*    request.patientContext              Condition | Device | Procedure | MedicationStatement | HealthcareServices
0..*    request.serviceInformationReference Procedure | HealthcareService | ServiceRequest | MedicationRequest | Medication | Device | DeviceRequest
